    ...
    <main id="maincontent" role="main" class="page-content">
		<div class="notfound">
			...
			<div class="read-moresec">
        		<a href="<?php echo esc_url( home_url() ); ?>" class="button hvr-sweep-to-right"><?php esc_html_e( 'Return to the home page', 'luxury-travel' ); ?><span class="screen-reader-text"><?php esc_html_e( 'Return to the home page', 'luxury-travel' ); ?></span></a>
			</div>
		</div>
