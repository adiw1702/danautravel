...
function luxury_travel_activation_notice() {
	echo '<div class="notice notice-success is-dismissible welcome">';
		echo '<h3>'. esc_html__( 'Greetings from Themeglance!!', 'luxury-travel' ) .'</h3>';
		echo '<p>'. esc_html__( 'A heartful thank you for choosing Themeglance. We promise to deliver only the best to you. Please proceed towards welcome section to get started.', 'luxury-travel' ) .'</p>';
...
function luxury_travel_widgets_init() {
	...
	for ($i=1; $i<=$footer_columns; $i++) {
		register_sidebar( array(
			'name'          => __( 'Footer ', 'luxury-travel' ) . $i,
			'id'            => 'footer-' . $i,
			'description'   => '',
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget'  => '</aside>',
...
add_filter('loop_shop_columns', 'luxury_travel_loop_columns');
	if (!function_exists('luxury_travel_loop_columns')) {
		function luxury_travel_loop_columns() {
...
function luxury_travel_scripts() {
	...
	wp_enqueue_script( 'luxury-travel-custom-scripts', get_template_directory_uri() . '/js/custom.js', array('jquery') );
...
/* Theme Credit link */
define('LUXURY_TRAVEL_PRO_THEME_URL',__('https://www.themesglance.com/themes/premium-travel-agency-wordpress-theme/','luxury-travel'));
define('LUXURY_TRAVEL_THEME_DOC',__('https://www.themesglance.com/demo/docs/luxury-travel-pro/','luxury-travel'));
define('LUXURY_TRAVEL_LIVE_DEMO',__('https://www.themesglance.com/luxury-travel/','luxury-travel'));
define('LUXURY_TRAVEL_FREE_THEME_DOC',__('http://themesglance.com/demo/docs/free-luxury-travel/','luxury-travel'));
define('LUXURY_TRAVEL_SUPPORT',__('https://wordpress.org/support/theme/luxury-travel/','luxury-travel'));
define('LUXURY_TRAVEL_REVIEW',__('https://wordpress.org/support/theme/luxury-travel/reviews/#new-post','luxury-travel'));
define('LUXURY_TRAVEL_SITE_URL',__('https://www.themesglance.com/themes/free-travel-agency-wordpress-theme/','luxury-travel'));

function luxury_travel_credit_link() {
    echo "<a href=".esc_url(LUXURY_TRAVEL_SITE_URL).">".esc_html__('Luxury Travel WordPress Theme','luxury-travel')."</a>";
}
