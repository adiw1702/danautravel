...
<div class="wrapper-info">
	<div class="col-left">
		...
		<div class="color_bg_blue">
			...
			<div class="coupon-code"><?php esc_html_e( 'Get', 'luxury-travel' ); ?> <span><?php esc_html_e( '20% off', 'luxury-travel' ); ?></span> <?php esc_html_e( 'on Premium Theme with the discount code: ', 'luxury-travel' ); ?> <span><?php esc_html_e( '" Get20 "', 'luxury-travel' ); ?></span></div>
		</div>
		<div class="started">
